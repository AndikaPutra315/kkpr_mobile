...
// Halaman Form untuk Edit Data Pernyataan Mandiri
class EditDataMandiriPage extends StatefulWidget {
  // [PERUBAHAN 2]: Menerima data yang akan diedit
  final MandiriData data;

  const EditDataMandiriPage({super.key, required this.data});

  @override
  State<EditDataMandiriPage> createState() => _EditDataMandiriPageState();
}

class _EditDataMandiriPageState extends State<EditDataMandiriPage> {
  ...
  void initState() {
    ...
    _alamatKantorController = TextEditingController(
    ...
    _alamatUsahaController = TextEditingController(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Edit Pernyataan Mandiri'),
